          ...
          <div className="flex flex-col xs:flex-row w-full sm:w-auto gap-2">
            <div className="relative w-full xs:w-auto">
              <input
                type="text"
                placeholder="Cari..."
                className="pl-8 pr-2 py-1.5 text-xs sm:text-sm border rounded-lg focus:outline-none ring-1 ring-gray-400 focus:ring-1 focus:ring-[#4F959D] w-full text-black"
                value={searchTerm}
